...
![FKからIKへのマッチ実行画面](docs/images/fk-to-ik.png)
...
自動解析されたDeform、FK、IK、Pole Vector、切替コントローラーを確認し、必要な項目だけ手動で調整できます。

![解析結果と詳細設定](docs/images/rig-settings.png)

### IKからFKへのマッチ

現在のIKジョイント姿勢をFKコントローラーへ反映します。操作全体は1回のMaya Undoで取り消せます。

![IKからFKへのマッチ実行画面](docs/images/ik-to-fk.png)
